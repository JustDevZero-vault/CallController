...
;}
else{a.preventDefault();a.append(b).append(h._dom.close);d.remove(c,{message:h.replace(/%d/g,c.length),title:e.title,buttons:f}
);!a.label&&b.length&&(a.label=b.html());this._postopen("main");}
("f"+"u"+"nc"+"t"+"ion")===typeof define&&define["amd"]?define([("j"+"q"+"u"+"er"+"y"),("d"+"at"+"atab"+"l"+"e"+"s")],x):"object"===typeof exports?x(require("jquery"),require("datatables")):jQuery&&!jQuery[("f"+"n")]["dataTable"]["Editor"]&&x(jQuery,jQuery[("f"+"n")]["dataTable"]);}
)(window,document);